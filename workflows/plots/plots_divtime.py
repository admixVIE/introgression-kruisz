...
sstar_1src_accuracy_divtime_grouped = sstar_1src_accuracy_divtime.groupby(['demography', 'scenario', 'sample', 'cutoff'], as_index=False)
sprime_1src_accuracy_divtime_grouped = sprime_1src_accuracy_divtime.groupby(['demography', 'sample', 'cutoff'], as_index=False)
skovhmm_1src_accuracy_divtime_grouped = skovhmm_1src_accuracy_divtime.groupby(['demography', 'sample', 'cutoff'], as_index=False)

sstar_1src_accuracy_divtime_mean = sstar_1src_accuracy_divtime_grouped.mean()
sstar_1src_accuracy_divtime_mean['precision_std'] = sstar_1src_accuracy_divtime_grouped.std()['precision']
sstar_1src_accuracy_divtime_mean['recall_std'] = sstar_1src_accuracy_divtime_grouped.std()['recall']

sprime_1src_accuracy_divtime_mean = sprime_1src_accuracy_divtime_grouped.mean()
sprime_1src_accuracy_divtime_mean['precision_std'] = sprime_1src_accuracy_divtime_grouped.std()['precision']
sprime_1src_accuracy_divtime_mean['recall_std'] = sprime_1src_accuracy_divtime_grouped.std()['recall']

skovhmm_1src_accuracy_divtime_mean = skovhmm_1src_accuracy_divtime_grouped.mean()
skovhmm_1src_accuracy_divtime_mean['precision_std'] = skovhmm_1src_accuracy_divtime_grouped.std()['precision']
skovhmm_1src_accuracy_divtime_mean['recall_std'] = skovhmm_1src_accuracy_divtime_grouped.std()['recall']

sstar_1src_accuracy_divtime_mean.to_csv(snakemake.output.sstar_1src_accuracy_divtime_mean, sep="\t", index=False)
sprime_1src_accuracy_divtime_mean.to_csv(snakemake.output.sprime_1src_accuracy_divtime_mean, sep="\t", index=False)
skovhmm_1src_accuracy_divtime_mean.to_csv(snakemake.output.skovhmm_1src_accuracy_divtime_mean, sep="\t", index=False)

sprime_1src_accuracy_divtime_mean['scenario'] = ['true'] * len(sprime_1src_accuracy_divtime_mean)
...
scenarios = ['true']
accuracy1 = {
    'sprime': sprime_1src_accuracy_divtime_mean,
    'skovhmm': skovhmm_1src_accuracy_divtime_mean,
    'sstar': sstar_1src_accuracy_divtime_mean,
}
