...
sstar_1src_accuracy_introtime = pd.read_csv(snakemake.input.sstar_1src_accuracy_introtime, sep="\t").dropna()
sprime_1src_accuracy_introtime = pd.read_csv(snakemake.input.sprime_1src_accuracy_introtime, sep="\t").dropna()
skovhmm_1src_accuracy_introtime = pd.read_csv(snakemake.input.skovhmm_1src_accuracy_introtime, sep="\t").dropna()

sstar_1src_accuracy_introtime_grouped = sstar_1src_accuracy_introtime.groupby(['demography', 'scenario', 'sample', 'cutoff'], as_index=False)
sprime_1src_accuracy_introtime_grouped = sprime_1src_accuracy_introtime.groupby(['demography', 'sample', 'cutoff'], as_index=False)
skovhmm_1src_accuracy_introtime_grouped = skovhmm_1src_accuracy_introtime.groupby(['demography', 'sample', 'cutoff'], as_index=False)

sstar_1src_accuracy_introtime_mean = sstar_1src_accuracy_introtime_grouped.mean()
sstar_1src_accuracy_introtime_mean['precision_std'] = sstar_1src_accuracy_introtime_grouped.std()['precision']
sstar_1src_accuracy_introtime_mean['recall_std'] = sstar_1src_accuracy_introtime_grouped.std()['recall']

sprime_1src_accuracy_introtime_mean = sprime_1src_accuracy_introtime_grouped.mean()
sprime_1src_accuracy_introtime_mean['precision_std'] = sprime_1src_accuracy_introtime_grouped.std()['precision']
sprime_1src_accuracy_introtime_mean['recall_std'] = sprime_1src_accuracy_introtime_grouped.std()['recall']

skovhmm_1src_accuracy_introtime_mean = skovhmm_1src_accuracy_introtime_grouped.mean()
skovhmm_1src_accuracy_introtime_mean['precision_std'] = skovhmm_1src_accuracy_introtime_grouped.std()['precision']
skovhmm_1src_accuracy_introtime_mean['recall_std'] = skovhmm_1src_accuracy_introtime_grouped.std()['recall']

sstar_1src_accuracy_introtime_mean.to_csv(snakemake.output.sstar_1src_accuracy_introtime_mean, sep="\t", index=False)
sprime_1src_accuracy_introtime_mean.to_csv(snakemake.output.sprime_1src_accuracy_introtime_mean, sep="\t", index=False)
skovhmm_1src_accuracy_introtime_mean.to_csv(snakemake.output.skovhmm_1src_accuracy_introtime_mean, sep="\t", index=False)

sprime_1src_accuracy_introtime_mean['scenario'] = ['true'] * len(sprime_1src_accuracy_introtime_mean)
skovhmm_1src_accuracy_introtime_mean['scenario'] = ['true'] * len(skovhmm_1src_accuracy_introtime_mean)
sstar_1src_accuracy_introtime_mean['scenario'] = ['true'] * len(sstar_1src_accuracy_introtime_mean)
...
scenarios = ['true']
accuracy1 = {
    'sprime': sprime_1src_accuracy_introtime_mean,
    'skovhmm': skovhmm_1src_accuracy_introtime_mean,
    'sstar': sstar_1src_accuracy_introtime_mean,
}
